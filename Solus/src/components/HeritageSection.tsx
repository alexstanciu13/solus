...
export function HeritageSection({ onNavigate }: HeritageSectionProps) {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <button
              ...
              className="border-2 border-[#c9a66b] text-[#c9a66b] px-10 py-4 tracking-luxury hover:bg-[#c9a66b] hover:text-black transition-all duration-300 mt-8"
