    ...
    <div className="min-h-screen bg-[#faf8f5] pt-32 pb-20">
      <div className="max-w-[1800px] mx-auto px-8 lg:px-16">
        ...
        <div className="text-center mb-20">
          ...
          <p
            className="tracking-luxury max-w-2xl mx-auto"
            style={{ fontSize: '15px', fontWeight: 300, color: '#2a2a2a', lineHeight: '1.8' }}
          >
            Editorial insights into our world of limited edition craftsmanship, heritage techniques, and the philosophy behind every piece we create.
          </p>
        </div>
